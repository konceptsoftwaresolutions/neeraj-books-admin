...
const VideoUploadField = ({
  ...
  return (
    <div className={`flex flex-col w-full gap-2 ${parentClass}`}>
      ...
      <div
        className={`flex items-center border relative w-full py-2 border-solid border-[#6E6E6E] overflow-hidden ${
          disabled
            ? "bg-[#eceff1] cursor-not-allowed"
      ...
      >
        <Controller
          ...
          render={({ field: { onChange, value } }) => (
            <>
              <h2
                className={`w-full px-2.5 text-[#6E6E6E] text-sm font-poppins placeholder:font-poppins placeholder:not-italic placeholder:text-sm placeholder:leading-normal placeholder:font-medium placeholder:text-[#6E6E6E] not-italic leading-normal bg-transparent font-medium outline-none border-none ${className}`}
              >
                {fileName}
              </h2>
