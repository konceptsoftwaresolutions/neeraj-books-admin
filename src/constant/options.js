...
export const bookSizeOptions = [
  { label: 'Medium - Regular (20/30/8)', value: 'medium-regular' },
  { label: 'Large - SLM (23/36/8)', value: 'large-slm' },
  { label: 'Small - HOS (23/36/16)', value: 'small-hos' },
  { label: 'Mini (20/30/16)', value: 'mini' },
];


export const colourOptions = [
  { label: "Single Colour", value: "singleColour" },
  { label: "Double Colour", value: "doubleColour" },
  { label: "Four Colour", value: "fourColour" },
];

export const blulkClientCategoryOptions = [
  { label: "College/Institute", value: "college-institute" },
...
export const paymentModeOptions = [
  ...
  { label: "Pre-Paid (Online)", value: "prepaid" },
];
...
export const profileOptions = [
  ...
  { label: 'Parent-admin', value: 'parent-admin' },
]

export const bestSellerOptions = [
  { label: "Yes", value: "yes" },
  { label: "No", value: "no" },
]
...
export const filteStateOptions = [
  { label: "All", value: "All" },
...
export const uttarakhandCities = [
  ...
  { label: "Devprayag", value: "Devprayag" },
  { label: "Kotdwar", value: "Kotdwar" }
];


export const uttarPradeshCities = [
  ...
  { label: "Allahabad (Prayagraj)", value: "Allahabad" },
  ...
  { label: "Faizabad (Ayodhya)", value: "Faizabad" },
  { label: "Shahjahanpur", value: "Shahjahanpur" }
];


export const tripuraCities = [
  ...
  { label: "Sabroom", value: "Sabroom" },
  { label: "Teliamura", value: "Teliamura" }
];
...
export const sikkimCities = [
  ...
  { label: "Dentam", value: "Dentam" },
  { label: "Yangang", value: "Yangang" },
  { label: "Zuluk", value: "Zuluk" },
  { label: "Yuksom", value: "Yuksom" }
];
...
export const meghalayaCities = [
  ...
  { label: "Ampati", value: "Ampati" },
  { label: "Khliehriat", value: "Khliehriat" },
  { label: "Mairang", value: "Mairang" },
  { label: "Sohra (Cherrapunjee)", value: "Sohra (Cherrapunjee)" },
  { label: "Amlarem", value: "Amlarem" }
];
...
export const madhyaPradeshCities = [
...
export const lakshadweepCities = [
...
export const ladakhCities = [
  { label: "Leh", value: "Leh" },
  { label: "Kargil", value: "Kargil" },
  { label: "Drass", value: "Drass" },
  { label: "Nubra", value: "Nubra" },
  { label: "Padum", value: "Padum" },
  { label: "Zanskar", value: "Zanskar" },
  { label: "Diskit", value: "Diskit" },
  { label: "Turtuk", value: "Turtuk" },
  { label: "Tangtse", value: "Tangtse" },
  { label: "Choglamsar", value: "Choglamsar" },
  { label: "Shey", value: "Shey" },
  { label: "Saspotsey", value: "Saspotsey" },
  { label: "Khaltsi", value: "Khaltsi" },
  { label: "Lamayuru", value: "Lamayuru" }
];
...
export const jammuAndKashmirCities = [
...
export const himachalPradeshCities = [
  ...
  { label: "Sundernagar", value: "Sundernagar" },
  { label: "Nalagarh", value: "Nalagarh" },
  { label: "Parwanoo", value: "Parwanoo" },
  { label: "Paonta Sahib", value: "Paonta Sahib" },
  { label: "Reckong Peo", value: "Reckong Peo" },
  { label: "Keylong", value: "Keylong" },
  { label: "Rampur", value: "Rampur" },
  { label: "Karsog", value: "Karsog" },
  { label: "Joginder Nagar", value: "Joginder Nagar" },
  { label: "Nurpur", value: "Nurpur" },
  { label: "Rohru", value: "Rohru" },
  { label: "Theog", value: "Theog" },
  { label: "Jubbal", value: "Jubbal" },
  { label: "Bharmour", value: "Bharmour" },
  { label: "Tissa", value: "Tissa" }
];
...
export const chhattisgarhCities = [
...
export const arunachalPradeshCities = [
...
export const andhraPradeshCities = [
